...
public class BrightnessController implements ToggleSlider.Listener {
    ...
    private ImageButton mMirrorIcon = null;
    ...
    public BrightnessController(Context context, ImageButton icon,
    ...
    private void updateIconInternal(boolean automatic, ImageButton icon) {
        if (icon != null) {
            if (automatic) {
